Log in to AutoDL and lease an image
Select image:
```
...
After downloading models, run the API
```
...
As shown in the figure below, click the `Custom Service` button for your machine to enable port forwarding service
...
TTS:
  FishSpeech:
    ...
    reference_text: ["Hello, I'm Xiaozhi, a Taiwanese girl with a pleasant voice. I'm super happy to meet you! What have you been busy with lately? Don't forget to give me some interesting gossip, I love listening to it!",]
    api_key: "123"
