...
- Disadvantages: As of September 25, 2025, the default model is a Chinese model that does not support English text-to-speech. If English is included, it won't produce sound. To support both Chinese and English simultaneously, you need to train your own model.
...
```
### 3. Install Paddle
Due to different CPU and GPU architectures, please create environment according to Python versions supported by Paddle official  
```
...
```
Please start the command according to the actual directory of your ```tts_online_application.yaml```. When you see the following log, the startup is successful
```
...
## 3. Modify Xiaozhi Configuration File
...
python app.py
```
Open test_page.html in the test directory to test whether PaddleSpeech has output logs when connecting and sending messages

Output log reference:
```
INFO:     127.0.0.1:44312 - "WebSocket /paddlespeech/tts/streaming" [accepted]
INFO:     connection open
[2025-08-07 11:16:33,355] [    INFO] - sentence: Haha, why did you suddenly come to chat with me?
